...
export const EFFECTS: EffectDef[] = [
  {
    ...
    params: [
      ...
      { key: 'spring',          label: 'Spring',       min: 0.5,  max: 15,    default: 3,    step: 0.5 },
      { key: 'noiseScale',      label: 'Noise scale',  min: 0,    max: 2,     default: 0.25, step: 0.05 },
      { key: 'noiseSpeed',      label: 'Noise speed',  min: 0,    max: 1,     default: 0.3,  step: 0.01 },
      { key: 'repulRadius',     label: 'Repel radius', min: 20,   max: 300,   default: 160,  step: 10, unit: 'px' },
      { key: 'repulStrength',   label: 'Repel force',  min: 0,    max: 15,    default: 8,    step: 0.5 },
  ...
  },
  {
    ...
    params: [
      ...
      { key: 'noiseSpeed',      label: 'Noise speed',  min: 0,    max: 1,     default: 0.3,  step: 0.01 },
      { key: 'repulRadius',     label: 'Repel radius', min: 20,   max: 300,   default: 180,  step: 10, unit: 'px' },
      { key: 'repulStrength',   label: 'Repel force',  min: 0,    max: 15,    default: 9,    step: 0.5 },
      { key: 'particleSize',    label: 'Size',         min: 1,    max: 8,     default: 2.5,  step: 0.1, unit: 'px' },
      { key: 'brightness',      label: 'Brightness',   min: 0.1,  max: 4,     default: 1,    step: 0.05 },
      { key: 'zoom',            label: 'Zoom',         min: 0.25, max: 4,     default: 1,    step: 0.05 },
    ],
  ...
  },
  {
    ...
    inputs: [],
    params: [
      { key: 'gridSpacing',  label: 'Spacing',        min: 4,   max: 80,  default: 9,   step: 1,    unit: 'px' },
      { key: 'dotRadius',    label: 'Dot size',        min: 0.1, max: 6,   default: 0.45,step: 0.05, unit: 'px' },
      { key: 'waveAmp',      label: 'Cursor push',     min: 0,   max: 120, default: 19,  step: 1,    unit: 'px' },
      { key: 'pushLag',      label: 'Push lag',        min: 0,   max: 1,   default: 0,   step: 0.05 },
      { key: 'waveRadius',   label: 'Cursor radius',   min: 0,   max: 500, default: 50,  step: 5,    unit: 'px' },
      { key: 'cursorForce',  label: 'Cursor force',    min: 0,   max: 5,   default: 4.7, step: 0.1 },
      ...
      { key: 'rippleFreq',   label: 'Ripple freq',     min: 0,   max: 5,   default: 0.4, step: 0.1,  unit: 'Hz' },
    ],
  },
]
